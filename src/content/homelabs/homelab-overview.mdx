...
objectives:
  ...
  - "Set up a containerized application server engineered with a Zero Trust architecture, utilizing Tailscale, Caddy, and CrowdSec to securely host internal microservices without public internet exposure."
requirements:
